...
class GSStepperColor{
  ...
  static const fadeGreen = Color(0x346CD38B);

  static const red = Color(0xffEF5350);

  static const fadeRed = Color(0x34ef5350);

  static const blue = Color(0xff0092E4);

  static const blueSwitchBackground = Color(0x660092e4);

  static const fadeBlue = Color(0x340092e4);
  ...
  static const textColor1 = Color(0xff262626);
  static const textColor2 = Color(0xff999999);

  static const cardBackground = Color(0xffffffff);
  static const divider = Color(0xffeaeaea);
  static const iconColor = Color(0xff262626);
  static const gridDivider = Color(0x261277d3);
  static const shadowColor = Color(0xF5B5858);
